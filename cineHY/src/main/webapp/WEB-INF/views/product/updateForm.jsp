    ...
    <div class="container mt-5">
        ...
        <form id="updateForm" method="post" action="update" enctype="multipart/form-data">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="${ product.productName }" name="productName" placeholder="상품 이름">
                </div>
            </div>
            <div class="form-group row">
                <label for="category" class="col-sm-2 col-form-label">카테고리</label>
                <div class="col-sm-10">
                      <select class="custom-select" id="categorySelect"  name="productCategory">
                        <option>선택</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" id="productInfo" rows="10"  name="productComment" placeholder="상품정보">${ product.productComment }</textarea>
                </div>
            </div>
            <div class="form-group row">
                <label for="price" class="col-sm-2 col-form-label">가격</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="price" value="${ product.productPrice }" name="productPrice" placeholder="가격">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div>
	                    <input type="file" id="upfile" class="form-control-file border" name="reUpFile" onchange="loadImg(this);">
						<input type="hidden" name="productImage" value="${ product.productImage }" />
						<input type="hidden" name="changeImage" value="${ product.changeImage }" />
					</div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="row">
                        <div class="col">
                        	<img id="imgArea" src="${ product.changeImage }" alt="">
                        </div>
                    </div>
                </div>
            </div>
