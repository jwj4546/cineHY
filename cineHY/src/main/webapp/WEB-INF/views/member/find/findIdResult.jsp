...
<body cellpadding="0" cellspacing="0" marginleft="0" margintop="0" width="100%" height="100%">
	...
	<div class="card align-middle" style="width:25rem;">
		...
		<div class="card-body">
      <form action="findId" id="findForm" class="form-signin" method="POST">
        ...
        <input type="email" class="form-control" id="email" placeholder="E-mail을 입력해주세요." name="email" required> <br>

        <button id="find_id" class="btn btn-lg btn-primary btn-block" onclick="findId()" type="submit">아이디 찾기</button>
